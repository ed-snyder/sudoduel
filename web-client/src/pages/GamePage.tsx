        ...
        <div className="px-3 sm:px-4" style={{ paddingTop: '0px', paddingBottom: '4px', marginTop: isCapacitor ? '4px' : '0px' }}>
          ...
          <div className="flex items-center justify-between gap-2" style={{ marginBottom: '4px' }}>
            ...
            <div className="flex items-center flex-1 min-w-0 relative">
              ...
              <div className="text-sm sm:text-base font-mono text-gray-700 whitespace-nowrap flex-shrink-0" style={{ position: 'relative', left: '-24px' }}>
            ...
            <div className="flex items-center flex-1 min-w-0 justify-end relative">
              <div className="text-sm sm:text-base font-mono text-gray-700 whitespace-nowrap flex-shrink-0" style={{ position: 'relative', right: '-24px' }}>
