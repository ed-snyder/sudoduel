        ...
        {searching ? (
          ...
          <>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full max-w-sm mt-4 py-3 rounded-xl transition-all hover:scale-105 active:scale-95"
              style={{
            ...
            >
              ...
              <span className="text-sm font-body font-semibold" style={{ color: '#5865F2' }}>Join the Discord!</span>
            </button>
          </>
        )}
      </div>
