      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-2 relative z-20">
        ...
        {searching ? (
          ...
          <>
            ...
            {/* Discord Button - Magenta pulsing style */}
            <button
              onClick={() => Browser.open({ url: 'https://discord.gg/24u2NKcQ' })}
              className="flex items-center justify-center gap-2 w-full max-w-sm mt-3 py-2.5 rounded-xl transition-all hover:scale-105 active:scale-95 shimmer-button magenta-glow-pulse"
              style={{
                background: 'rgba(255, 0, 255, 0.08)',
                border: '2px solid rgba(255, 0, 255, 0.6)',
              }}
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#FF00FF">
              ...
              <span className="text-sm font-body font-semibold" style={{ color: '#FF00FF' }}>Join the Discord!</span>
            </button>
          </>
        )}
      </div>
