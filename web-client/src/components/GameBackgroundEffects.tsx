...
export default function GameBackgroundEffects({ 
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: -1 }}>
      ...
      <div className="absolute inset-0">
        ...
        <div 
          ...
          style={{
            ...
            maxHeight: 600,
            background: `radial-gradient(circle, 
              rgba(92, 0, 128, 0.12) 0%, 
              rgba(255, 0, 255, 0.08) 30%,
              rgba(92, 0, 128, 0.03) 40%, 
              transparent 70%)`,
            borderRadius: '50%',
            filter: 'blur(55px)',
      ...
      {/* NOISE TEXTURE OVERLAY - Static PNG, zero performance cost */}
      <div 
